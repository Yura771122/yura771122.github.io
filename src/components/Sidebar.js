    ...
    <Fragment>
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark slide-in-left">
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          >
            <span className="fs-5 d-none d-sm-inline ff-jost fw-600">Yura</span>
          </Link>
          <ul
            ...
            >
              {/* <li>
                <a
                  ...
                  href="mailto:gohilyagnik3@email.com"
                  target="/blank"
                >
              ...
              {/* <li>
                <a
                  className="dropdown-item text-black"
                  href="https://www.linkedin.com/in/gohil-yagnik-087601189/"
                  target="/blank"
                >
              ...
              <li>
                <a
                  className="dropdown-item text-black"
                  href="https://github.com/Yura771122"
                  target="/blank"
                >
              ...
              {/* <li>
                <a
                  className="dropdown-item text-black"
                  href="https://yagnik-19.showwcase.com/"
                  target="/blank"
                >
                  <VscAccount className="fs-5" /> Showwcase
                </a>
              </li> */}
            </ul>
          </div>
